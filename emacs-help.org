...
*** 領域の扱いまとめ
    ...
    |         | M-h       |      | ak-mark-sentence 後方拡大  |
    |         | M-H       |      | ak-mark-sentence 前方拡大  |
    |         |           |      | mark-end-of-sentence       |
    | M-k     |           |      | kill-sentence              |
    | C-x DEL |           |      | backward-kill-sentence     |
    |         |           |      |                            |
    |         | M-{       |      | forward-paragraph  (逆)    |
    |         | M-}       |      | backward-paragraph (逆)    |
    |         | M-]       |      | ak-mark-paragraph 後方拡大 |
    |         |           |      | mark-paragraph             |
    |         |           |      | kill-paragraph             |
    |         |           |      |                            |
    | C-x h   |           | s-a  | mark-whole-buffer          |
    ...
    | C-M-n   | C-M-next  |      | forward-list               |
    | C-M-p   | C-M-prior |      | backward-list              |
    | /       | <         |      |                            |
